...
public class ProjectFeatureTest {
    ...
    public void SoftShadowTest(){
        ...
        Render render = new Render(imageWriter, scene).setAmountOfRaysForAntiAliasing(50).setAmountOfRaysForSoftShadow(300).setMultithreading(3).setDebugPrint().setRadiusOfLightSource(10).enableBVH();
