...
public class ReflectionRefractionTests {
    ...
    public void houseMirrored(){
        Scene scene = new Scene("Test scene");
        scene.set_camera(new Camera(new Point3D(0, 0,-350), new Vector(0, 0, 1), new Vector(0, -1, 0)));
        scene.set_distance(1000);
        scene.set_background(Color.BLACK);
        scene.set_ambientLight(new AmbientLight(new Color(java.awt.Color.WHITE), 0.15));

        scene.addGeometries( //
                new Polygon(new Color(20, 20, 20), new Material(0, 0, 0,0,1), //
                        new Point3D(10, -40, 0), new Point3D(10, 40, 0), new Point3D(10, 40, 40),new Point3D(10,-40,40)), //
                new Polygon(new Color(java.awt.Color.blue),new Material(0.5,0.5,50,0.5,0),//
                        new Point3D(10,-10,0),new Point3D(10,-10,20),new Point3D(20,-10,20),new Point3D(20,-10,0) ),//
                new Triangle(new Color(java.awt.Color.red), new Material(0.5, 0.5, 60), //
                        new Point3D(10, -10, 20), new Point3D(20, -10, 20), new Point3D(10, -10, 30)), //
                new Sphere(new Color(java.awt.Color.yellow), new Material(0.2, 0.2, 30), // )
                        10, new Point3D(20, 20, 10)));
